...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sandry_mc' => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST_SANDRY', '127.0.0.1'),
            'port' => env('DB_PORT_SANDRY', '5432'),
            'database' => env('DB_DATABASE_SANDRY', 'forge'),
            'username' => env('DB_USERNAME_SANDRY', 'forge'),
            'password' => env('DB_PASSWORD_SANDRY', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'schema' => 'public',
        ...
        'topten_mc'  => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST_TOPTEN', '127.0.0.1'),
            'port' => env('DB_PORT_TOPTEN', '5432'),
            'database' => env('DB_DATABASE_TOPTEN', 'forge'),
            'username' => env('DB_USERNAME_TOPTEN', 'forge'),
            'password' => env('DB_PASSWORD_TOPTEN', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'schema' => 'public',
